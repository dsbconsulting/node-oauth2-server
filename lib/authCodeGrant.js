...
function saveAuthCode (done) {
  ...
  console.log('Saving authCode: ', this.client.clientId, this.authCode);
...
function redirect (done) {
  var redirectURI = this.client.redirectUri + '?code=' + this.authCode + (this.req.query.state ? '&state=' + this.req.query.state : '') + (this.req.query.scope ? '&scope=' + this.req.query.scope : '');
  console.log('Redirecting authCode to client: ',  this.client.clientId, redirectURI);
